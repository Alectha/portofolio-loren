...
export default function KeyAchievements() {
	return (
		<section id="achievements" className="py-10 sm:py-12 px-4 sm:px-6 max-w-5xl mx-auto">
			...
			<div className="grid md:grid-cols-2 gap-4 sm:gap-6">
				<GlassCard className="p-4 flex items-center justify-center">
					<div className="flex items-center gap-3 text-center sm:text-left">
						...
						<p className="mt-0 font-bold text-(--text-primary) text-sm sm:text-base">Awardee GenBI 2026</p>
					</div>
				</GlassCard>
				...
				<GlassCard className="p-4 flex items-center justify-center">
					<a
						...
						target="_blank"
						rel="noreferrer"
						className="flex items-center gap-2 text-(--text-primary) font-bold hover:underline text-sm sm:text-base"
